...
export default function Footer() {
  ...
  // If we're on the embed page, don't show the footer
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:justify-between">
          <div className="mb-6 md:mb-0">
            <Link href="/">
              <a className="text-[#E50914] text-xl font-bold">MovieStream</a>
            </Link>
            <p className="text-gray-400 text-sm mt-2">Upload and stream your movies</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white text-sm">Guidelines</a></li>
        ...
        <div className="mt-8 border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between">
          <p className="text-xs text-gray-400">&copy; {new Date().getFullYear()} MovieStream. All rights reserved.</p>
